 ...
 */
public class GridAdapter_MyInfo extends RecyclerView.Adapter<GridAdapter_MyInfo.ViewHolder> {

    private Myinfo_Activity activity;
    private List<Book_Info> book_infos;
    private boolean click_flag;
    private final static int REQ_CODE = 4321;

    //생성자
    public GridAdapter_MyInfo(Myinfo_Activity activity, List<Book_Info> list, boolean flag) {
